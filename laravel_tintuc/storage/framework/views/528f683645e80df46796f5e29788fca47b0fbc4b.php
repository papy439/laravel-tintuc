	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
			<div class="home_bottom">
				...
				<ul>
					<?php if(isset($trongnuoc) && count($trongnuoc) > 0): ?>
					<?php $__currentLoopData = $trongnuoc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<li>
