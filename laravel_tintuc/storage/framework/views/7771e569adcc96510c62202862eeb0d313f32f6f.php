...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo e(url('/')); ?>" class="nav-link" target="_blank">Xem website</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          Xin chào: <b>Admin</b><i class="far fa-hand-point-down"></i>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="<?php echo e(url('logout')); ?>" class="dropdown-item dropdown-footer">Thoát</a>
        </div>
      </li>
    </ul>
  </nav>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0"><?php echo $__env->yieldContent('heading'); ?></h1>
          </div><!-- /.col -->
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="<?php echo e(url('/')); ?>">TrollNew</a>.</strong>
    All rights reserved.
