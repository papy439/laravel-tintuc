	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
			<div class="home_bottom">
				<div class="heading">
						<?php echo e($PageInfo->name); ?>

				</div>
				<ul>
					<?php if(isset($covid) && count($covid) > 0): ?>
					<?php $__currentLoopData = $covid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<li>
